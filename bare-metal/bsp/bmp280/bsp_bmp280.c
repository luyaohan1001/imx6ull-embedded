...
/***
  * @brief      : 从BMP280的原始温度数据值计算出真实的温度数据值
  * @param - uncomptemp  : 原始的温度数据值
  * @retval         : 得到的真实的数据值，这里将温度值扩大了100倍
  *              比如5123 = 51.23°C。
  */
...
/***
  * @brief      : 从BMP280的原始气压数据值计算出真实的气压数据值
  * @param - uncomppres  : 原始的气压数据值
  * @retval         : 得到的真实的气压数据值，比如23658就是:
